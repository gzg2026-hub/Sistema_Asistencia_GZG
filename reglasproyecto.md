...
- ÚNICAMENTE los siguientes **2 archivos** tienen autorización explícita para subida/sincronización automática a Google Drive (**Directamente en la carpeta `AGOSTO`, SIN CREAR SUBDIRECTORIOS NI SUBCARPETAS**):
