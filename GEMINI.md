...
- **Deducción Universal de Error Humano en Marcación**:
  * **Botón H.E. Matutino (Caso Jhon Ágreda / Raúl Lázaro)**: Si un trabajador presenta una marcación matutina (05:00 AM a 09:30 AM) etiquetada como `"Inicio de horas extra"`, `"Inicio H.E."`, `"Fin de horas extra"` o `"Fin H.E."`, y posteriormente registra una salida en la tarde/noche (17:00 a 20:30 PM) sin existir otra entrada matutina previa, el motor deduce un **error humano de botón en la terminal biométrica**. Se reclasifica automáticamente en la evaluación como `"Registro de entrada"`, asignándole el **Turno DÍA** y evaluando el día limpiamente como `ASISTIO`.
