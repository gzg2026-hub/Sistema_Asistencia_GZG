...
with sync_playwright() as p:
                ...
                body: JSON.stringify({
                    RecordRequest: {
                        ...
                        QueryInfo: {
                            ...
                            BeginTime: "2026-08-17T00:00:00-05:00",
    ...
    for idx, r in enumerate(records[:15]):
        p_name = r.get("PersonInfo", {}).get("FullName")
        time_str = r.get("SwipeTime", "")[11:19]
        v_type = r.get("VerifyType")
        s_type = r.get("SwipeType")
        print(f"Row {idx+1}: {p_name} | {time_str} | SwipeType={s_type} | VerifyType={v_type}")
