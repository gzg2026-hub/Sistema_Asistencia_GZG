...
$trigger = New-ScheduledTaskTrigger -Once -At 11:40AM
$settings = New-ScheduledTaskSettingsSet -StartWhenAvailable -AllowStartIfOnBatteries -DontStopIfGoingOnBatteries

Register-ScheduledTask -TaskName "GZG_Hikvision_Descarga_Test_1140" -Action $action -Trigger $trigger -Settings $settings -User "GZG Minerales 2026" -Force
