...
data = r.json()
print("Record response keys:", data.keys())

records = data.get("RecordResponse", {}).get("RecordList", [])
print(f"🎉 SE ENCONTRARON {len(records)} MARCACIONES REALES!")

if records:
    print("\nEjemplo de primera marcación:")
